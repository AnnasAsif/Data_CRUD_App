...
from environment.config import ANALYTICS_COLLECTION

async def create_analytics_record(analytics: Analytics, project_name: str) -> dict:
    """Create a new analytics record"""
    db = get_analytics_db()
    collection_name = f"{ANALYTICS_COLLECTION}_{project_name}"
